...
| -------------- | ---------------- | ------------- |
| TL-WDR5660 | V2.0升级软件20190827_2.5.124 | https://service.tp-link.com.cn/detail_download_7977.html |
...
| --- | --- |
| `memcpy` | `0x801D027C` |
| `copy_msg_element` | `0x80232B38` |
| `parse_msg_element` | `0x80232B78` |
| `parse_advertisement_frame` | `0x80232FC4` |
| `ms_idle_handler` | `0x8023323C` |
| `protocol_handler` | `0x8023358C` |

The vulnerable copy site was observed around `0x80232B60` during reverse analysis.
...
- The firmware's operating system is VxWorks 5.5.1, and the main binary is `400_5660`. The symbol table file was also used during analysis. Then, we used a self-developed emulation tool specifically designed for VxWorks to start the service and perform validation.
